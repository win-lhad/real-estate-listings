...
final class RealEstatesListingServiceMock: RealEstatesListingService {
  ...
  func configureSuccess(with response: PropertiesListingDTO = PropertiesListingMocks.sample) {
    fetchPropertiesListingResult = response
    fetchPropertiesListingError = nil
  }

  func configureSuccessEmpty() {
    fetchPropertiesListingResult = PropertiesListingMocks.empty
    fetchPropertiesListingError = nil
  }
